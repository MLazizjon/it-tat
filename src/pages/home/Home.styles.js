...
export const FeatureCard = styled.div`
  ...
  transition: 0.3s;
  &:nth-child(even) { transform: translateY(40px); }
...
export const CourseCard = styled.div`
  ...
  .arrow {
    ...
    color: #4154f1; font-size: 24px; cursor: pointer;
  }
`;
...
export const PartnersGrid = styled.div`
  ...
  img { filter: grayscale(100%); opacity: 0.7; transition: 0.3s; &:hover { filter: grayscale(0); opacity: 1; } }
`;
...
export const ContactInfoCard = styled.div`
  ...
  .office-img { width: 100%; border-radius: 15px; margin-bottom: 25px; }
  ...
  .value { color: #555; font-size: 16px; margin-top: 5px; border-bottom: 1px solid #eee; padding-bottom: 10px; }
`;

// --- 8. Registration (Qiyalikdagi taglar bilan) ---
...
export const RegisterContainer = styled.div`
  ...
  max-width: 1200px;
  margin: 0 auto;
  @media (max-width: 992px) { flex-direction: column; gap: 80px; }
`;
...
export const FormCard = styled.div`
  ...
  p { margin-bottom: 35px; opacity: 0.9; line-height: 1.5; }
  ...
  button {
    width: 100%; padding: 20px; border-radius: 15px; background: #5c67f2; 
    color: white; border: none; font-size: 18px; font-weight: 700; 
    cursor: pointer; transition: 0.3s;
    &:hover { background: #4a54e1; box-shadow: 0 10px 20px rgba(0,0,0,0.2); }
  }
`;
...
export const FAQHeader = styled.div`
  ...
  color: #1a237e;
  font-size: 17px;
  span { color: #4154f1; font-size: 20px; }
`;
...
export const FooterCol = styled.div`
  h4 { font-size: 18px; margin-bottom: 30px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; }
  ul { list-style: none; }
  li { margin-bottom: 15px; font-size: 16px; opacity: 0.8; cursor: pointer; transition: 0.2s; &:hover { opacity: 1; padding-left: 5px; } }
  
  .footer-logo { width: 140px; margin-bottom: 25px; }
  .desc { font-size: 15px; line-height: 1.6; opacity: 0.8; }
  
  .contact-item { font-size: 18px; font-weight: 600; margin-bottom: 10px; display: block; }
  ...
  .socials {
    ...
    a { 
      ...
      &:hover { background: white; color: #4154f1; transform: translateY(-5px); }
    }
  }
`;
